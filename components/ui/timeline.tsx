      ...
      >
        ...
        <div ref={ref} className="relative max-w-7xl -mt-2 mx-auto pb-10">
          {data.map((item, index) => (
            <div
              key={index}
              className="flex justify-start pt-10 swap:pt-40 swap:gap-10"
            >
              ...
              <div className="relative pl-20 pr-4 swap:pl-4 w-full">
                <h3 className="swap:hidden block text-2xl mb-4 text-left font-bold text-neutral-500 dark:text-neutral-500">
                  {item.title}
                </h3>
                {item.content}{" "}
              </div>
